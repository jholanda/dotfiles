#!/bin/bash
# Instala o que este repo controla numa máquina Arch: os scripts em bin/ e,
# quando fizer sentido, a automação de backup (systemd timer).
#
# Uso:
